...
func TestRouteMatrixDeclaresCredentialBoundaries(t *testing.T) {
	tests := []struct {
		...
		{http.MethodPost, "/api/v1/admin/users", RouteAuthCookie, true, true},
		{http.MethodPost, "/api/v1/admin/users/u1/enable", RouteAuthCookie, true, true},
		...
		{http.MethodPost, "/api/v1/admin/mounts/mnt_1/reverify", RouteAuthCookie, true, true},
		{http.MethodPut, "/api/v1/admin/mounts/mnt_1/grants/account_1", RouteAuthCookie, true, true},
		{http.MethodDelete, "/api/v1/admin/mounts/mnt_1/grants/account_1", RouteAuthCookie, true, true},
