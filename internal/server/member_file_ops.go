...
func memberLocatorFromQuery(r *http.Request) (access.Locator, error) {
	...
	case contentref.SourceCollaboration:
		locator.CollaborationID = strings.TrimSpace(query.Get("collaborationId"))
		if locator.CollaborationID == "" || query.Get("mountId") != "" {
			return access.Locator{}, errors.New("collaboration locator requires collaborationId")
		}
	default:
		return access.Locator{}, errors.New("source must be personal, common_mount, or collaboration")
	}
	return locator, nil
}
