...
func (s *Server) apiRoutes() {
	...
	s.mux.Handle("GET /api/v1/admin/updates", s.gate(domain.RouteGroupREST, http.HandlerFunc(s.updateStatus)))
	s.mux.Handle("POST /api/v1/admin/updates", s.gate(domain.RouteGroupREST, http.HandlerFunc(s.uploadUpdate)))
	s.mux.Handle("POST /api/v1/admin/updates/rollback", s.gate(domain.RouteGroupREST, http.HandlerFunc(s.rollbackUpdate)))
